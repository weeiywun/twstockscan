...
function renderStrategy() {
  ...
  const tableHTML = `
    <div class="table-wrap">
      ...
      <table id="resultsTable" class="bigscan-table">
        <thead>
          <tr>
